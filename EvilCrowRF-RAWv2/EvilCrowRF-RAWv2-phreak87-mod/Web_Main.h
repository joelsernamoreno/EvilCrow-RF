...
<li><a href="#" onClick="NavigateFrame('/frqscan' );Hide(this)">Frequency Scan</a></li>
...
<ul>
<li><a href="#" onClick="NavigateFrame('/RUN.WBF');Hide(this)">Beacon Flooding (Offline)</a></li>
<li><a href="#" onClick="NavigateFrame('/RUN.IPC');Hide(this)">Iphone-CrashAP  (Offline)</a></li>
