...
<FORM action="/settxbinary" method="post" id="config" target="iframe">
    ...
    <hr>
    <p>Binary Data: </p><textarea class="console" form="config" rows="1" cols="50" name="binarydata"></textarea>
    <hr>
    <p>Sample Pulse: </p><textarea class="console" form="config" rows="1" cols="50" name="samplepulse"></textarea>
    <hr>
